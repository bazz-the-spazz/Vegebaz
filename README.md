...
- ... extract the indicator_value data from
    ...
    - [Vegedaz 2024](https://www.wsl.ch/de/services-produkte/vegedaz/) (*read_data_from_Vegedaz_2024.r*)
...
- ... assign communites to vegetation types TypoCH (*Calculate_indicator_values.r*)
